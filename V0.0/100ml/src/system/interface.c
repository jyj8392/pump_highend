...
//	u8 SetLuminStepPos = 9;
	...
	sprintf(FlowStr, "%03d.%01d", sysctl->setFlow/10, sysctl->setFlow%10);
...
//						ShowASCII816Str(1+8+9, 5, (sysctl->flowMode == 1? "M": "A"), SetTab0Pos[1]);
					...
					case 1:
						...
						sprintf(PressMaxStr, "%02d.%02d", sysctl->pressMax/100, sysctl->pressMax%100);
						sprintf(PressMinStr, "%02d.%02d", sysctl->pressMin/100, sysctl->pressMin%100);
						sprintf(PurgeFlowStr, "%03d.%01d", sysctl->purgeFlow/10, sysctl->purgeFlow%10);
					...
					case 3:
						...
						ShowBlock();
						if (SetShowCntPage == 0) {														
							ShowASCII816Str(1, 4, "0.01", 0);sprintf(ShowCntStr, "%05d", PUMP_FlowCnts[0].cnt);ShowASCII816Str(1+8+5, 4, ShowCntStr, 0);
							ShowASCII816Str(1, 24, "0.02", 0);sprintf(ShowCntStr, "%05d", PUMP_FlowCnts[1].cnt);ShowASCII816Str(1+8+5, 24, ShowCntStr, 0);
							ShowASCII816Str(1, 44, "0.05", 0);sprintf(ShowCntStr, "%05d", PUMP_FlowCnts[2].cnt);ShowASCII816Str(1+8+5, 44, ShowCntStr, 0);
							ShowASCII816Str(28, 4, "0.10", 0);sprintf(ShowCntStr, "%05d", PUMP_FlowCnts[3].cnt);ShowASCII816Str(28+8+5, 4, ShowCntStr, 0);
							ShowASCII816Str(28, 24, "00.20", 0);sprintf(ShowCntStr, "%05d", PUMP_FlowCnts[4].cnt);ShowASCII816Str(28+8+5, 24, ShowCntStr, 0);
							ShowASCII816Str(28, 44, "00.50", 0);sprintf(ShowCntStr, "%05d", PUMP_FlowCnts[5].cnt);ShowASCII816Str(28+8+5, 44, ShowCntStr, 0);
						} else if (SetShowCntPage == 1) {
							ShowASCII816Str(1, 4, "01.00", 0);sprintf(ShowCntStr, "%05d", PUMP_FlowCnts[6].cnt);ShowASCII816Str(1+8+5, 4, ShowCntStr, 0);
							ShowASCII816Str(1, 24, "02.00", 0);sprintf(ShowCntStr, "%05d", PUMP_FlowCnts[7].cnt);ShowASCII816Str(1+8+5, 24, ShowCntStr, 0);
							ShowASCII816Str(1, 44, "05.00", 0);sprintf(ShowCntStr, "%05d", PUMP_FlowCnts[8].cnt);ShowASCII816Str(1+8+5, 44, ShowCntStr, 0);
							ShowASCII816Str(28, 4, "100.0", 0);sprintf(ShowCntStr, "%05d", PUMP_FlowCnts[9].cnt);ShowASCII816Str(28+8+5, 4, ShowCntStr, 0);
...
//						ShowASCII816Str(1+8+9, 5, (sysctl->flowMode == 1? "M": "A"), SetTab0Pos[1]);
				...
				case KEYNUM0:
					if (SetTab1PosIndex == 0) {
						...
						PurgeFlowStr[2] = SetPurgeFlowPos[2] + 0x30;
						PurgeFlowStr[3] = '.';
...
//						OLED_SetContrast(sysctl->backLumin);
				...
				case KEYLEFT:
					if (SetShowCntPage == 1) {
						...
						SetShowCntPage = 1;
						ShowASCII816Str(1, 4, "010.0", 0);sprintf(ShowCntStr, "%05d", PUMP_FlowCnts[6].cnt);ShowASCII816Str(1+8+5, 4, ShowCntStr, 0);
						ShowASCII816Str(1, 24, "020.0", 0);sprintf(ShowCntStr, "%05d", PUMP_FlowCnts[7].cnt);ShowASCII816Str(1+8+5, 24, ShowCntStr, 0);
						ShowASCII816Str(1, 44, "050.0", 0);sprintf(ShowCntStr, "%05d", PUMP_FlowCnts[8].cnt);ShowASCII816Str(1+8+5, 44, ShowCntStr, 0);
						ShowASCII816Str(28, 4, "100.0", 0);sprintf(ShowCntStr, "%05d", PUMP_FlowCnts[9].cnt);ShowASCII816Str(28+8+5, 4, ShowCntStr, 0);
						ShowASCII816Str(28, 24, " P.G.", 0);sprintf(ShowPressStr, " %04d", PUMP_PressArg.pg);ShowASCII816Str(28+8+5, 24, ShowPressStr, 0);
						ShowASCII816Str(28, 44, " P.Z.", 0);sprintf(ShowPressStr, " %01d.%02d", PUMP_PressArg.pz/100, PUMP_PressArg.pz%100);ShowASCII816Str(28+8+5, 44, ShowPressStr, 0);
					}	 					
