...
void ADC_Configuration(void)
{
	...
	ADC_RegularChannelConfig(ADC1, ADC_Channel_15, 3, ADC_SampleTime_13Cycles5);
	ADC_RegularChannelConfig(ADC1, ADC_Channel_14, 4, ADC_SampleTime_13Cycles5);
	ADC_RegularChannelConfig(ADC1, ADC_Channel_7, 5, ADC_SampleTime_13Cycles5);
	ADC_RegularChannelConfig(ADC1, ADC_Channel_6, 6, ADC_SampleTime_13Cycles5);

	ADC_RegularChannelConfig(ADC1, ADC_Channel_5, 7, ADC_SampleTime_13Cycles5);
	ADC_RegularChannelConfig(ADC1, ADC_Channel_4, 8, ADC_SampleTime_13Cycles5);
	ADC_RegularChannelConfig(ADC1, ADC_Channel_12, 9, ADC_SampleTime_13Cycles5);
	ADC_RegularChannelConfig(ADC1, ADC_Channel_13, 10, ADC_SampleTime_13Cycles5);
	//  ADC_RegularChannelConfig(ADC1, ADC_Channel_14, 11, ADC_SampleTime_13Cycles5);
	//  ADC_RegularChannelConfig(ADC1, ADC_Channel_15, 12, ADC_SampleTime_13Cycles5);
...
void DMA_Configuration(void)
{
	...
	DMA_InitStructure.DMA_BufferSize = 1200;//设置DMA在传输时缓冲区的长度 word (写完一组后自动从头开始）
