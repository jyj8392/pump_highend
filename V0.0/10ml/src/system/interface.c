...
//						ShowASCII816Str(1+8+9, 5, (sysctl->flowMode == 1? "M": "A"), SetTab0Pos[1]);
					...
					case 1:
						...
						sprintf(PressMaxStr, "%02d.%02d", sysctl->pressMax/100, sysctl->pressMax%100);
						sprintf(PressMinStr, "%02d.%02d", sysctl->pressMin/100, sysctl->pressMin%100);
						sprintf(PurgeFlowStr, "%01d.%03d", sysctl->purgeFlow/1000, sysctl->purgeFlow%1000);
					...
					case 3:
						...
						ShowBlock();
						if (SetShowCntPage == 0) {														
							ShowASCII816Str(1, 4, "0.010", 0);sprintf(ShowCntStr, "%05d", PUMP_FlowCnts[0].cnt);ShowASCII816Str(1+8+5, 4, ShowCntStr, 0);
							ShowASCII816Str(1, 24, "0.020", 0);sprintf(ShowCntStr, "%05d", PUMP_FlowCnts[1].cnt);ShowASCII816Str(1+8+5, 24, ShowCntStr, 0);
							ShowASCII816Str(1, 44, "0.050", 0);sprintf(ShowCntStr, "%05d", PUMP_FlowCnts[2].cnt);ShowASCII816Str(1+8+5, 44, ShowCntStr, 0);
							ShowASCII816Str(28, 4, "0.100", 0);sprintf(ShowCntStr, "%05d", PUMP_FlowCnts[3].cnt);ShowASCII816Str(28+8+5, 4, ShowCntStr, 0);
							ShowASCII816Str(28, 24, "0.200", 0);sprintf(ShowCntStr, "%05d", PUMP_FlowCnts[4].cnt);ShowASCII816Str(28+8+5, 24, ShowCntStr, 0);
							ShowASCII816Str(28, 44, "0.500", 0);sprintf(ShowCntStr, "%05d", PUMP_FlowCnts[5].cnt);ShowASCII816Str(28+8+5, 44, ShowCntStr, 0);
						} else if (SetShowCntPage == 1) {
							ShowASCII816Str(1, 4, "1.000", 0);sprintf(ShowCntStr, "%05d", PUMP_FlowCnts[6].cnt);ShowASCII816Str(1+8+5, 4, ShowCntStr, 0);
							ShowASCII816Str(1, 24, "2.000", 0);sprintf(ShowCntStr, "%05d", PUMP_FlowCnts[7].cnt);ShowASCII816Str(1+8+5, 24, ShowCntStr, 0);
							ShowASCII816Str(1, 44, "5.000", 0);sprintf(ShowCntStr, "%05d", PUMP_FlowCnts[8].cnt);ShowASCII816Str(1+8+5, 44, ShowCntStr, 0);
							ShowASCII816Str(28, 4, "10.00", 0);sprintf(ShowCntStr, "%05d", PUMP_FlowCnts[9].cnt);ShowASCII816Str(28+8+5, 4, ShowCntStr, 0);
...
//						ShowASCII816Str(1+8+9, 5, (sysctl->flowMode == 1? "M": "A"), SetTab0Pos[1]);
				...
				case KEYNUM0:
					if (SetTab1PosIndex == 0) {
						...
						PurgeFlowStr[1] = '.';
						PurgeFlowStr[2] = SetPurgeFlowPos[1] + 0x30;
